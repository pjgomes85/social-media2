...
export default function Sidebar() {
  ...
  const nonActiveElementClasses = 'flex gap-3 py-2 my-2 hover:bg-blue-500 hover:bg-opacity-20 -mx-4 px-4 rounded-md transition-all hover:scale-110 hover:shadow-md shadow-gray-500';
  return (
    <Card>
